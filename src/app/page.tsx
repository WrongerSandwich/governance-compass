  ...
  return (
    <main className="min-h-screen px-4">
      ...
      <div className="max-w-xl mx-auto pt-16 pb-12 text-center">
        ...
        <Link
          href="/quiz"
          className="block mx-auto max-w-xs bg-stone-600 text-white py-3 px-8 rounded-sharp text-sm font-medium hover:bg-stone-700 transition-colors duration-150 text-center focus:outline-none focus-visible:outline-2 focus-visible:outline-stone-600 focus-visible:outline-offset-2"
        >
          Begin assessment
        </Link>
