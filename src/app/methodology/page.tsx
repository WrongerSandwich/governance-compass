      ...
      <article className="mx-auto max-w-2xl">
        ...
        <div className="space-y-10 text-sm text-text-secondary leading-relaxed">
          ...
          <section id="sources">
            ...
            <div className="space-y-4">
              <p>
                World map geometry on the{" "}
                <Link href="/study/personas" className="text-text-primary hover:text-text-secondary transition-colors duration-150 underline underline-offset-2 decoration-border-secondary">
                  personas gazetteer
                </Link>{" "}
                is derived from{" "}
                <a
                ...
                (110m Cultural Vectors, public domain), aggregated to a custom ten-region taxonomy at build time.
              </p>
              <p>
                The April 2026 synthetic study used Gemini 2.5 Flash to generate 1,002 biographical personas, then administered the Governance Compass instrument to each persona twice — once via Claude Sonnet 4.6 and once via Gemini 2.5 Flash. The full dataset is available as a JSON download from the{" "}
                <Link href="/study" className="text-text-primary hover:text-text-secondary transition-colors duration-150 underline underline-offset-2 decoration-border-secondary">
