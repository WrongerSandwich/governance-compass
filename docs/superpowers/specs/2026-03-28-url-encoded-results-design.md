...
67 response values packed into a compact, URL-safe string using bitpacking + base64url.

| Field | Values | Bits per item | Total bits |
|-------|--------|--------------|------------|
| Version | 1 byte prefix (currently `0x03`) | 8 | 8 |
| 36 FC responses | A/B/skip (3 states) | 2 | 72 |
| 24 SC responses | 1-5/skip (6 states) | 3 | 72 |
| 7 budget allocations | 1-25 range (25 values) | 5 | 35 |

**Total: 187 bits = 24 bytes = ~32 chars base64url.**
...
URL format: `/results?r=AaF3x9Mk2pLs8nQ...` (~38 chars total with prefix).
